-- E2E test fixture for the `kozou dev` full-stack Playwright suite.
--
-- Same schema + seed as the @kozou/svelte-ui E2E fixture (kept as an
-- independent copy so this suite is self-contained), so the dashboard /
-- CRUD assertions line up across both suites.
--
