// Composite foreign-key relation picker, end-to-end against the in-house
// @kozou/api server (KOZOU_ADAPTER_KIND=api, wired in global-setup). One
// picker drives BOTH key columns of
