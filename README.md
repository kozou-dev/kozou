...
```bash
docker pull ghcr.io/kozou-dev/kozou:v1.5.0
docker run --rm ghcr.io/kozou-dev/kozou:v1.5.0 inspect --help
docker run --rm ghcr.io/kozou-dev/kozou:v1.5.0 mcp --help
```
...
Runtime requirements for v1.5.0:
