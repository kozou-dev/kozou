...
```bash
docker pull ghcr.io/kozou-dev/kozou:v1.18.0
docker run --rm ghcr.io/kozou-dev/kozou:v1.18.0 mcp --help
```
...
Runtime requirements for v1.18.0:
...
- Beyond v1.18: React UI exploration — optional write-path parity (a second UI driving create / edit / delete across both adapters)
