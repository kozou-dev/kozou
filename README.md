...
```bash
docker pull ghcr.io/kozou-dev/kozou:v1.4.2
docker run --rm ghcr.io/kozou-dev/kozou:v1.4.2 inspect --help
docker run --rm ghcr.io/kozou-dev/kozou:v1.4.2 mcp --help
```
...
Runtime requirements for v1.4.2:
